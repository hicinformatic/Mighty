...
if 'mighty.apps.nationality' in settings.INSTALLED_APPS:
    ...
    urlpatterns += urls_nationality.urlpatterns
        ...
        #from mighty.apps.nationality.urls import apipatterns as urls_nationatliy_api
        #apipatterns += urls_nationatliy_api
        #apipatterns += [path('api/', include(urls_nationatliy_api)),]
...
if 'mighty.apps.user' in settings.INSTALLED_APPS:
    ...
    #if 'rest_framework' in settings.INSTALLED_APPS:
        #from mighty.apps.user.urls import apipatterns as urls_user_api
        #apipatterns += urls_user_api
